...
SIDER_ROOT_DATA = "%s/SIDER4_Data" % DATA_FOLDER # xinya
TOX_ROOT_DATA = "%s/TOXRIC_Data" % DATA_FOLDER # xinya
...
KFOLD_FOLDER_EC_SIDER = "%s/kfolds_ec_sider" % DATA_FOLDER # xinya
KFOLD_FOLDER_EC_TOX = "%s/kfolds_ec_toxric" % DATA_FOLDER # xinya
...
AEOLUS_CHEM_PATH = "%s/drugCidInfo_update.dat" % AEOLUS_ROOT_DATA # xinya
AEOLUS_BIO2RDF_PATH = "%s/drugBio2RDF.dat" % AEOLUS_ROOT_DATA
AEOLUS_RDKIT_PATH = "%s/AEOLUS_RDkit.dat" % AEOLUS_ROOT_DATA # xinya
AEOLUS_ECFP_PATH = "%s/AEOLUS_Feature.dat" % AEOLUS_ROOT_DATA
AEOLUS_INFO = "%s/AEOLUS_ECFP.info" % AEOLUS_ROOT_DATA


SIDER_ADR_PATH = "%s/sider4_adr.tsv" % SIDER_ROOT_DATA
# SIDER_CHEM_PATH = "%s/drug_info_update.tsv" % SIDER_ROOT_DATA
SIDER_CHEM_PATH = "%s/drugCidInfo_update.dat" % SIDER_ROOT_DATA
SIDER_BIO2RDF_PATH = "%s/sider4_Bio2RDF.dat" % SIDER_ROOT_DATA
# SIDER_RDKIT_PATH = "%s/sider4_Morgan.dat" % SIDER_ROOT_DATA # xinya
SIDER_RDKIT_PATH = "%s/sider4_RDkit.dat" % SIDER_ROOT_DATA # xinya
SIDER_ECFP_PATH = "%s/sider4_ecfp.dat" % SIDER_ROOT_DATA
SIDER_INFO = "%s/sider4.info" % SIDER_ROOT_DATA # xinya


TOX_TOXCITY_PATH = "%s/toxric_tox_cleaned.tsv" % TOX_ROOT_DATA
TOX_CHEM_PATH = "%s/drug_info_cleaned.tsv" % TOX_ROOT_DATA
TOX_BIO2RDF_PATH = "%s/toxric_Rdkit2D.tsv" % TOX_ROOT_DATA
TOX_ECFP_PATH = "%s/toxric_ecfp.dat" % TOX_ROOT_DATA
TOX_INFO = "%s/toxric.info" % TOX_ROOT_DATA # xinya
